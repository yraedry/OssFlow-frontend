...
export function FlexibilidadPage() {
  ...
  const sessions = (data?.content ?? []).filter((s) => s.sessionType === 'FLEXIBILITY')
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Sesiones de flexibilidad y estiramiento</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-muted-foreground">
          <p>No hay sesiones de flexibilidad todavía.</p>
