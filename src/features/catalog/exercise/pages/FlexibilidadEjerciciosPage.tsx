      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-3">
            <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400" style={{ fontFamily: 'var(--font-mono)' }}>
  ...
  return (
    <div className="space-y-6">
      ...
      <SearchInput
        ...
        placeholder="Buscar ejercicios de flexibilidad..."
      />
      ...
      {isLoading ? (
        ...
        <div className="border border-dashed border-border py-16 text-center text-muted-foreground">
          ...
          <p className="text-sm font-medium">{debouncedSearch ? `Sin resultados para "${debouncedSearch}"` : 'No hay ejercicios de flexibilidad'}</p>
          {!debouncedSearch && <p className="text-xs mt-1">Añade tu primer estiramiento o ejercicio de movilidad articular</p>}
        </div>
      ) : (
        <>
