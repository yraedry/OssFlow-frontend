    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="border border-dashed border-border py-16 text-center text-muted-foreground">
          ...
          <p className="text-sm font-medium">No hay ejercicios de flexibilidad</p>
          <p className="text-xs mt-1">Añade tu primer estiramiento o ejercicio de movilidad articular</p>
        </div>
      ) : (
        <>
