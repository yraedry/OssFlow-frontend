...
import { Moon, Sun, BookOpen, Layers, Dumbbell, Target, User } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/journal/notes', label: 'Notas', icon: BookOpen },
  { to: '/planning/study-plans', label: 'Planes', icon: Dumbbell },
